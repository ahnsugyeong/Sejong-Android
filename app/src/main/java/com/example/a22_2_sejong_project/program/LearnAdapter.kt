...
class LearnAdapter(val context: Context, val programList : Elements) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        view.program_list_title_tv.text = programList.select("li")[position].select("b.title").text()
